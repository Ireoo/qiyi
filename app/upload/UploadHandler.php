...
class UploadHandler
{
    ...
    function __construct($url, $dir, $options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            ...
            'readfile_chunk_size' => 1024 * 1024, // 10 MiB
...
//            print_r($file_path);
//            $file_path = md5(radom(0, 9999999999)).$type;
