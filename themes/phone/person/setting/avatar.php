...
<script type="text/javascript">
    ...
    {
        // your code here
        xiuxiu.loadPhoto("http://ireoo.com/user/<?php echo $_SESSION['user']['id']; ?>.jpg?<?php echo rand(0, 9999999999999999999); ?>");
    };

    xiuxiu.setUploadURL("http://ireoo.com/app/xiuxiu/avatar.php");
